...
- `getMyOrders()` - устарел в API v0.5 (всегда пустой результат)
...
### NftMethods
- `give()` - передать NFT
- `info()` - получить информацию о NFT
- `list()` - получить список NFT
- `history()` - история NFT
...
При возникновении проблем или вопросов создавайте issue на [GitHub](https://github.com/C0dwiz/IrisAPI-dart/issues).
